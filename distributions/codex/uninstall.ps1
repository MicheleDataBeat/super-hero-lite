...
# It removes only package-owned state.
# It delegates to the same Python implementation as ./uninstall.sh.
...
& $python -B (Join-Path $DistributionDir 'lib/managed_state.py') uninstall `
